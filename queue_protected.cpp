...
void queue_protected::new_k(int num) {
	set_k(num);
}

void queue_protected::new_a(elem*value) {
	set_a(value);
}

void queue_protected::new_b(elem*value) {
	set_b(value);
}
